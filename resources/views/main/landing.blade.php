      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
              <img src="{{ URL::to('assets/img/Top-Photo.png') }}" alt="Hero Image" class="img-fluid">

              <div class="customers-badge">
                <div class="customer-avatars">
                  <img src="{{ URL::to('assets/img/avatar-1.webp') }}" alt="Customer 1" class="avatar">
                  <img src="{{ URL::to('assets/img/avatar-2.webp') }}" alt="Customer 2" class="avatar">
                  <img src="{{ URL::to('assets/img/avatar-3.webp') }}" alt="Customer 3" class="avatar">
                  <img src="{{ URL::to('assets/img/avatar-4.webp') }}" alt="Customer 4" class="avatar">
                  <img src="{{ URL::to('assets/img/avatar-5.webp') }}" alt="Customer 5" class="avatar">
                  <span class="avatar more">12+</span>
                </div>
                <p class="mb-0 mt-2">Over 1,000,000 of commuters since start of our services. </p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row stats-row gy-4 mt-5" data-aos="fade-up" data-aos-delay="500">
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              <div class="stat-icon">
                <img src="{{ URL::to('assets/img/bus/earth-star.png') }}" alt="Customer 1" class="avatar" style="width: 75px; height: 112px;">
              </div>
              <div class="stat-content">
                <h4>Earth Star Transports</h4>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              <div class="stat-icon">
                <img src="{{ URL::to('assets/img/bus/es-logo-600.png') }}" alt="Customer 1" class="avatar" style="width: 75px; height: 85px;">
              </div>
              <div class="stat-content">
                <h4>ES Transports</h4>
              </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              <div class="stat-icon">
                <img src="{{ URL::to('assets/img/bus/jell-trans.png') }}" alt="Customer 1" class="avatar" style="width: 112px; height: 95px;">
              </div>
              <div class="stat-content">
                <h4>Jell Transports</h4>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              <div class="stat-icon">
                ...
                <img src="{{ URL::to('assets/img/bus/kellen-logo.png') }}" alt="Customer 1" class="avatar" style="width: 112px; height: 90px;">
              </div>
              <div class="stat-content">
                <h4>Kellen Transports</h4>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row gy-4 align-items-center justify-content-between">
              ...
              <div class="row gy-4">
                <div class="col-lg-5">
                  <div class="profile d-flex align-items-center gap-3">
                    <img src="{{ URL::to('assets/img/avatar-1.webp') }}" alt="CEO Profile" class="profile-image">
                    <div>
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="{{ URL::to('images position-relative') }}" data-aos="zoom-out" data-aos-delay="400">
                <img src="{{ URL::to('assets/img/group-bus.jpg') }}" alt="Business Meeting" class="img-fluid main-image rounded-4">
                <img src="{{ URL::to('assets/img/about-2.webp') }}" alt="Team Discussion" class="img-fluid small-image rounded-4">
              </div>
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="tab-pane fade active show" id="features-tab-1">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{ URL::to('assets/img/features-illustration-1.webp') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane fade" id="features-tab-2">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{ URL::to('assets/img/features-illustration-2.webp') }}" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End tab content item -->
          ...
          <div class="tab-pane fade" id="features-tab-3">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{ URL::to('assets/img/features-illustration-3.webp') }}" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End tab content item -->
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="phone-mockup text-center">
              <img src="{{ URL::to('assets/img/phone-app-screen.webp') }}" alt="Phone Mockup" class="img-fluid">
            </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-1.png') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-2.png') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-3.png') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-4.png') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-5.png') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-6.png') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-7.png') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ URL::to('assets/img/clients/client-8.png') }}" class="img-fluid" alt=""></div>
          </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="testimonial-item">
              <img src="{{ URL::to('assets/img/testimonials/testimonials-1.jpg') }}" class="testimonial-img" alt="">
              <h3>Saul Goodman</h3>
              <h4>Ceo &amp; Founder</h4>
              <div class="stars">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="testimonial-item">
              <img src="{{ URL::to('assets/img/testimonials/testimonials-2.jpg') }}" class="testimonial-img" alt="">
              <h3>Sara Wilsson</h3>
              <h4>Designer</h4>
              <div class="stars">
                <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="testimonial-item">
              <img src="{{ URL::to('assets/img/testimonials/testimonials-3.jpg') }}" class="testimonial-img" alt="">
              <h3>Jena Karlis</h3>
              <h4>Store Owner</h4>
              <div class="stars">
                <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="testimonial-item">
              <img src="{{ URL::to('assets/img/testimonials/testimonials-4.jpg') }}" class="testimonial-img" alt="">
              <h3>Matt Brandon</h3>
              <h4>Freelancer</h4>
              <div class="stars">
                <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
