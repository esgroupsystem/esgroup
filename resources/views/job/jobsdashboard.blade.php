                                ...
                                <tbody>
                                    @forelse($applications as $index => $app)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $app->job->job_type ?? 'N/A' }}</td>
                                            <td class="text-center">{{ $app->phone ?? 'N/A' }}</td>
                                            <td class="text-center">
                                                <div class="dropdown action-label">
                                                    <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        @else
                                                            <i class="fa fa-dot-circle-o text-secondary"></i> Pending
                                                        @endif
                                                    </a>
                                            ...
                                            <td class="text-center">
                                                @if($app->cv_upload)
                                                    <a href="{{ route('resume.download', basename($app->cv_upload)) }}" 
