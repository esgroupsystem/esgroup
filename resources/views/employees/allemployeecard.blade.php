            ...
            @foreach ($employees as $employee)
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                        ...
                        <!-- Status badge -->
                        <span
                            class="badge badge-{{ $employee->status === 'Active' ? 'success' : 'secondary' }} position-absolute"
                            style="top: 10px; right: 10px;">
                            {{ $employee->status }}
                        </span>

                        <div class="profile-img">
                            @if ($user && ($user->role_name === 'Admin' || $user->role_name === 'DPO' || $approved))
                            ...
                            @else
                                <a href="{{ url('employee/request-approval/' . $employee->id) }}" class="avatar">
                                    <img class="user-profile" src="{{ asset('assets/employeepic/default.png') }}"
                                        alt="Restricted">
                                </a>
                            @endif
                        </div>
                        ...
                        @else
                            <a href="{{ url('employee/request-approval/' . $employee->id) }}"
                                class="btn btn-warning btn-sm">Request Access</a>
                        @endif
                    </div>
                </div>
            @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" style="width: 100%;" tabindex="-1" id="name"
                                        name="name" required oninput="capitalizeWords(this)">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" style="width: 100%;" tabindex="-1"
                                        aria-hidden="true" name="company" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" style="width: 100%;" tabindex="-1"
                                        aria-hidden="true" name="department" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" style="width: 100%;" tabindex="-1"
                                        aria-hidden="true" name="designation" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" style="width: 100%;" tabindex="-1"
                                        aria-hidden="true" name="garage" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input class="form-control datetimepicker" type="text" name="date_hired"
                                            required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" style="width: 100%;" tabindex="-1"
                                        aria-hidden="true" name="status" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img id="profilePicPreview" src="{{ asset('assets/employeepic/default.png') }}"
