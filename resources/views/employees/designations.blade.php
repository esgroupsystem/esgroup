                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="department">{{ $items->designation }}</td>
                                    <td class="text-right">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('userDesignation') }}" method="POST" >
                            @csrf
                    ...
                    <div class="modal-body">
                        ...
                        @csrf
                         <input type="hidden" name="id" id="e_id" value="">
                            <div class="form-group">
                                <label>Designation Name <span class="text-danger">*</span></label>
                                <input class="form-control" id="designation_edit"  name="designation" type="text" value="">
                            </div>
                            <div class="submit-section">
    ...
    @section('script')
        ...
        <script>
            $(document).on('click','.edit_designation',function()
            {
                ...
                $('#designation_edit').val(_this.find('.designation').text().trim());
            });
        </script>
        {{-- delete model --}}
        <script>
