<ul class="nav nav-tabs nav-tabs-solid nav-justified">
    <li class="nav-item"><a class="nav-link {{set_active(['/stocks/Mirasol'])}}" href="{{ route('/stocks/Mirasol') }}">Mirasol</a></li>
    <li class="nav-item"><a class="nav-link {{set_active(['/stocks/Balintawak'])}}" href="{{ route('/stocks/Balintawak') }}">Balintawak</a></li>
    <li class="nav-item"><a class="nav-link {{set_active(['/stocks/VGC'])}}" href="{{ route('/stocks/VGC') }}">VGC</a></li>
