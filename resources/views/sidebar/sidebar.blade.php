        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="menu-title"><span>Authentication</span></li>
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li>
                            {!! privilege_link('userManagement', ['Admin'], 'All User', set_active(['search/user/list', 'userManagement'])) !!}
                        </li>
                    </ul>
                </li>
                    <!--*
                ...
                <li class="{{ set_active(['receiving.index']) }} submenu">
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li>
                            {!! privilege_link('receiving.index', ['Maintenance', 'Admin'], 'Manage Orders', set_active(['receiving.index'])) !!}
                        </li>
                    </ul>
                </li>
                ...
                <li class="{{ set_active(['transfer.index']) }} submenu">
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li>
                            {!! privilege_link('transfer.index', ['Maintenance', 'Admin'], 'Transfer Records', set_active(['transfer.index'])) !!}
                        </li>
                    </ul>
                </li>
                ...
                <li class="{{ set_active(['/stocks/Mirasol']) }} submenu">
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li>
                            {!! privilege_link('/stocks/Mirasol', ['Maintenance', 'Admin'], 'Stocks Garage', set_active(['/stocks/Mirasol'])) !!}
                        </li>
                    </ul>
                </li>
                <!--*
                ...
                <li class="menu-title"><span>IT</span></li>
                    <li class="{{ set_active(['form/joborders/page', 'form/joborders/save', 'form/joborders/update', 'form/joborders/delete']) }} submenu">
                        ...
                        <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                            <li>
                                {!! privilege_link('form/joborders/page', ['IT', 'Admin', 'Maintenance'], 'Job Orders', set_active(['form/joborders/page'])) !!}
                            </li>
                        </ul>
                    </li>
                <!--*
                ...
                <li class="menu-title"> <span>Employees</span> </li>
                    ...
                    <li class="{{ set_active(['form/expense/reports/page','form/invoice/reports/page','form/leave/reports/page','form/daily/reports/page','form/payments/reports/page','form/employee/reports/page']) }} submenu">
                        <a href="#" class="{{ set_active(['form/expense/reports/page','form/invoice/reports/page','form/leave/reports/page','form/daily/reports/page','form/payments/reports/page','form/employee/reports/page']) ? 'noti-dot' : '' }}">
                            <i class="la la-pie-chart"></i> <span> Reports </span> <span class="menu-arrow"></span>
                        </a>
                        <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                            <li>{!! privilege_link('form/expense/reports/page', ['HR', 'Admin'], 'Expense Report', set_active(['form/expense/reports/page'])) !!}</li>
                            <li>{!! privilege_link('form/invoice/reports/page', ['HR', 'Admin'], 'Invoice Report', set_active(['form/invoice/reports/page'])) !!}</li>
                            <li>{!! privilege_link('form/payments/reports/page', ['HR', 'Admin'], 'Payments Report', set_active(['form/payments/reports/page'])) !!}</li>
                            <li>{!! privilege_link('form/employee/reports/page', ['HR', 'Admin'], 'Employee Report', set_active(['form/employee/reports/page'])) !!}</li>
                            <li><a href="payslip-reports.html">Payslip Report</a></li>
                            <li><a href="attendance-reports.html">Attendance Report</a></li>
                            <li>{!! privilege_link('form/leave/reports/page', ['HR', 'Admin'], 'Leave Report', set_active(['form/leave/reports/page'])) !!}</li>
                            <li>{!! privilege_link('form/daily/reports/page', ['HR', 'Admin'], 'Daily Report', set_active(['form/daily/reports/page'])) !!}</li>
                        </ul>
                    </li>
                ...
                <!--*
                    ...
                    *-->
                    ...
                    <li class="{{ set_active(['user/dashboard/index','jobs/dashboard/index','user/dashboard/all','user/dashboard/applied/jobs',
                        ...
                        'page/manage/resumes','page/shortlist/candidates','page/interview/questions',
                        'page/offer/approvals','page/experience/level','page/candidates','page/schedule/timing',
                        'page/aptitude/result']) }} submenu">

                        <a href="#" class="{{ set_active(['user/dashboard/index','jobs/dashboard/index','user/dashboard/all','user/dashboard/save',
                            'jobs','job/applicants','job/details']) ? 'noti-dot' : '' }}">
                ...
                <li class="{{ set_active(['category/list', 'form/saving', 'form/delete', 'brand/list', 
                                        ...
                                        'product/list', 'form/product/saving', 'form/product/update', 'form/product/delete',
                                        'getProductCode', 'garageIndex']) }} submenu">
                    <a href="#" class="{{ set_active(['product/list', 'category/list', 'brand/list', 'unit/list']) ? 'noti-dot' : '' }}">
