                        ...
                        <form action="{{ route('user/add/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" id="e_named" name="name" value="{{ old('name') }}" placeholder="Enter Name">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <label>Emaill Address</label>
                                    <input class="form-control" type="email" id="e_address" name="email" placeholder="Enter Email">
                                </div>
                            </div>
                            <div class="row"> 
                                <div class="col-sm-6"> 
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input class="form-control" type="tel" id="e_tel" name="phone" placeholder="Enter Phone">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-sm-6"> 
                                    <label>Photo</label>
                                    <input class="form-control" type="file" id="e_imaged" name="image">
                                </div>
                            </div>
                            <br>
                            <div class="row"> 
...
<script type="text/javascript">
    ...
    <script>
        $(document).on('click', '.userUpdate', function() {
            ...
            const userId = _this.find('.user_id').text().trim();
